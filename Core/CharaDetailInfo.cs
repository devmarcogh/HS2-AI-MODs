...
namespace StudioModsMSG
{
        ...
        public virtual bool IsData
        {
            get
            {
                return Type != CharaDetailDefineType.UNKNOWN &&
                       ...
                       Type != CharaDetailDefineType.DYNAMIC_CLOTH;
            }
        }
    ...
    class CharaDetailSet
    {
        ...
        public static CharaDetailDefine[] ClothDetailBuilder(ChaControl charInfo, int index)
        {
            ...
            int slot = index;
            if (charInfo.sex == 0) { // male
                if (index == 2) slot = 4; // gloves slot
                else if (index == 3) slot = 7; // shoes slot
            }
            CmpClothes cmpCloth = charInfo.cmpClothes[slot];
            ...
            CharaDetailDefine[] clothColorInfoDetailBuilder(int clothSlot, int colorIndex)
            {
                void updateClothPatternLayout(ChaControl chaCtrl, int clothSlotL, int colorIndexL, string axis, float newValue)
                {
                    Vector4 oldLayout = chaCtrl.nowCoordinate.clothes.parts[clothSlotL].colorInfo[colorIndexL].layout;
                    Vector4 newLayout;
                    if (axis == "x")
                        ...
                        throw new Exception();
                    chaCtrl.nowCoordinate.clothes.parts[clothSlotL].colorInfo[colorIndexL].layout = newLayout;
                    chaCtrl.chaFile.coordinate.clothes.parts[clothSlotL].colorInfo[colorIndexL].layout = newLayout;
                    chaCtrl.ChangeCustomClothes(clothSlotL, true, false, false, false);
                }
                ...
                CharaDetailDefine color = new CharaDetailDefine
                {
                    ...
                    Type = CharaDetailDefine.CharaDetailDefineType.COLOR,
                    Get = (chaCtrl) => { return chaCtrl.nowCoordinate.clothes.parts[clothSlot].colorInfo[colorIndex].baseColor; },
                    Set = (chaCtrl, v) => {
                        chaCtrl.nowCoordinate.clothes.parts[clothSlot].colorInfo[colorIndex].baseColor = (Color)v;
                        chaCtrl.chaFile.coordinate.clothes.parts[clothSlot].colorInfo[colorIndex].baseColor = (Color)v;
                        chaCtrl.ChangeCustomClothes(clothSlot, true, false, false, false);
                    },
                };
                colorInfo.Add(color);
                ...
                CharaDetailDefine gloss = new CharaDetailDefine
                {
                    ...
                    Type = CharaDetailDefine.CharaDetailDefineType.SLIDER,
                    Get = (chaCtrl) => { return chaCtrl.nowCoordinate.clothes.parts[clothSlot].colorInfo[colorIndex].glossPower; },
                    Set = (chaCtrl, v) =>
                    {
                        chaCtrl.nowCoordinate.clothes.parts[clothSlot].colorInfo[colorIndex].glossPower = (float)v;
                        chaCtrl.chaFile.coordinate.clothes.parts[clothSlot].colorInfo[colorIndex].glossPower = (float)v;
                        chaCtrl.ChangeCustomClothes(clothSlot, true, false, false, false);
                    },
                };
                colorInfo.Add(gloss);
                ...
                CharaDetailDefine metallic = new CharaDetailDefine
                {
                    ...
                    Type = CharaDetailDefine.CharaDetailDefineType.SLIDER,
                    Get = (chaCtrl) => { return chaCtrl.nowCoordinate.clothes.parts[clothSlot].colorInfo[colorIndex].metallicPower; },
                    Set = (chaCtrl, v) =>
                    {
                        chaCtrl.nowCoordinate.clothes.parts[clothSlot].colorInfo[colorIndex].metallicPower = (float)v;
                        chaCtrl.chaFile.coordinate.clothes.parts[clothSlot].colorInfo[colorIndex].metallicPower = (float)v;
                        chaCtrl.ChangeCustomClothes(clothSlot, true, false, false, false);
                    },
                };
                ...
                CharaDetailDefine pattern = new CharaDetailDefine
                {
                    ...
                    Type = CharaDetailDefine.CharaDetailDefineType.SELECTOR,
                    Get = (chaCtrl) => { return chaCtrl.nowCoordinate.clothes.parts[clothSlot].colorInfo[colorIndex].pattern; },
                    Set = (chaCtrl, v) =>
                    {
                        chaCtrl.nowCoordinate.clothes.parts[clothSlot].colorInfo[colorIndex].pattern = (int)v;
                        chaCtrl.chaFile.coordinate.clothes.parts[clothSlot].colorInfo[colorIndex].pattern = (int)v;
                        chaCtrl.ChangeCustomClothes(clothSlot, false, colorIndex == 0, colorIndex == 1, colorIndex == 2);
                        // update cloth type
                ...
                // pattern detail
                if (charInfo.nowCoordinate.clothes.parts[clothSlot].colorInfo[colorIndex].pattern != 0)
                {
                    // pattern color
                    CharaDetailDefine patternColor = new CharaDetailDefine
                    {
                        ...
                        Type = CharaDetailDefine.CharaDetailDefineType.COLOR,
                        Get = (chaCtrl) => { return chaCtrl.nowCoordinate.clothes.parts[clothSlot].colorInfo[colorIndex].patternColor; },
                        Set = (chaCtrl, v) => {
                            chaCtrl.nowCoordinate.clothes.parts[clothSlot].colorInfo[colorIndex].patternColor = (Color)v;
                            chaCtrl.chaFile.coordinate.clothes.parts[clothSlot].colorInfo[colorIndex].patternColor = (Color)v;
                            chaCtrl.ChangeCustomClothes(clothSlot, true, false, false, false);
                        },
                    };
                    ...
                    CharaDetailDefine patternWidth = new CharaDetailDefine
                    {
                        ...
                        Type = CharaDetailDefine.CharaDetailDefineType.SLIDER,
                        Get = (chaCtrl) => { return chaCtrl.nowCoordinate.clothes.parts[clothSlot].colorInfo[colorIndex].layout.x; },
                        Set = (chaCtrl, v) => { updateClothPatternLayout(chaCtrl, clothSlot, colorIndex, "x", (float)v); },
                    };
                    ...
                    CharaDetailDefine patternHeight = new CharaDetailDefine
                    {
                        ...
                        Type = CharaDetailDefine.CharaDetailDefineType.SLIDER,
                        Get = (chaCtrl) => { return chaCtrl.nowCoordinate.clothes.parts[clothSlot].colorInfo[colorIndex].layout.y; },
                        Set = (chaCtrl, v) => { updateClothPatternLayout(chaCtrl, clothSlot, colorIndex, "y", (float)v); },
                    };
                    ...
                    CharaDetailDefine patternX = new CharaDetailDefine
                    {
                        ...
                        Type = CharaDetailDefine.CharaDetailDefineType.SLIDER,
                        Get = (chaCtrl) => { return chaCtrl.nowCoordinate.clothes.parts[clothSlot].colorInfo[colorIndex].layout.z; },
                        Set = (chaCtrl, v) => { updateClothPatternLayout(chaCtrl, clothSlot, colorIndex, "z", (float)v); },
                    };
                    ...
                    CharaDetailDefine patternY = new CharaDetailDefine
                    {
                        ...
                        Type = CharaDetailDefine.CharaDetailDefineType.SLIDER,
                        Get = (chaCtrl) => { return chaCtrl.nowCoordinate.clothes.parts[clothSlot].colorInfo[colorIndex].layout.w; },
                        Set = (chaCtrl, v) => { updateClothPatternLayout(chaCtrl, clothSlot, colorIndex, "w", (float)v); },
                    };
                    ...
                    CharaDetailDefine patternRotate = new CharaDetailDefine
                    {
                        ...
                        Type = CharaDetailDefine.CharaDetailDefineType.SLIDER,
                        Get = (chaCtrl) => { return chaCtrl.nowCoordinate.clothes.parts[clothSlot].colorInfo[colorIndex].rotation; },
                        Set = (chaCtrl, v) =>
                        {
                            chaCtrl.nowCoordinate.clothes.parts[clothSlot].colorInfo[colorIndex].rotation = (float)v;
                            chaCtrl.chaFile.coordinate.clothes.parts[clothSlot].colorInfo[colorIndex].rotation = (float)v;
                            chaCtrl.ChangeCustomClothes(clothSlot, true, false, false, false);
                        },
                    };
                ...
                colorInfo.Add(new CharaDetailDefine
                {
                    ...
                    Upd = (chaCtrl) => { cec.RestoreClothDefaultColor(clothName, clothSlot, colorIndex); },
                });
            ...
            CharaDetailDefine clothType = new CharaDetailDefine
            {
                ...
                Type = CharaDetailDefine.CharaDetailDefineType.SELECTOR,
                Get = (chaCtrl) => { return chaCtrl.nowCoordinate.clothes.parts[slot].id; },
                Set = (chaCtrl, v) =>
                {
                    chaCtrl.chaFile.coordinate.clothes.parts[slot].id = (int)v;
                    chaCtrl.ChangeClothes(slot, (int)v, false);
                    // update cloth type
                    cec.UpdateDetailInfo_ClothType(clothName);
                },
            ...
            if (cmpCloth != null)
            {
                ...
                clothDetails.Add(new CharaIntStatusDetailDefine
                {
                    ...
                    Get = (chaCtrl) => { return chaCtrl.fileStatus.clothesState[slot]; },
                    Set = (chaCtrl, v) => { chaCtrl.SetClothesState(slot, Convert.ToByte(v), true); },
                ...
                clothDetails.Add(new CharaDetailDefine
                {
                    ...
                    Type = CharaDetailDefine.CharaDetailDefineType.BUTTON,
                    Upd = (chaCtrl) => { cec.RestoreClothDefaultColor(clothName, slot, -1); },
                });

                // color 1
                if (cmpCloth.useColorA01 || cmpCloth.useColorN01)
                {
                    clothDetails.AddRange(clothColorInfoDetailBuilder(slot, 0));
                }

                // color 2
                if (cmpCloth.useColorA02 || cmpCloth.useColorN02)
                {
                    clothDetails.AddRange(clothColorInfoDetailBuilder(slot, 1));
                }

                // color 3
                if (cmpCloth.useColorA03 || cmpCloth.useColorN03)
                {
                    clothDetails.AddRange(clothColorInfoDetailBuilder(slot, 2));
                }
        ...
        public static string[] ClothUpdateSequenceKeyBuilder(ChaControl charInfo, int index)
        {
            ...
            keyList.Add("Clothes#" + clothName + "#Cloth Component");
